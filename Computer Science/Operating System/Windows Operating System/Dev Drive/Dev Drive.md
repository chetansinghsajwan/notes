...
## How Dev Drive works
The **Dev Drive** utilizes [[Resilient File System]] enabling you to initialize a storage volume specifically for development workloads, providing faster performance, and customizable settings that are optimized for development scenarios.
## Performance

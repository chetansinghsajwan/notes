An _implicit conversion sequence_ is the sequence of conversions required to convert an expression to the type of the corresponding parameter in a function declaration.

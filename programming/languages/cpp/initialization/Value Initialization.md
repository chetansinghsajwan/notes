...
## Effects
1. If `T` is a class type with no [default constructor](https://en.cppreference.com/w/cpp/language/default_constructor) or with a user-declared u[ser-provided](https://en.cppreference.com/w/cpp/language/function#User-provided_functions) or deleted default constructor, the object performs [[Default Initiailization]].

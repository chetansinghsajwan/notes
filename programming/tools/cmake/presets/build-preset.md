...
> ##### `inherits` (`string | [string]`) #optional 
> 
...
> ##### `configurePreset` (type: `string`) (required)
> 
...
> ##### `inheritConfigureEnvironment` (type: `bool`) (optional)
> 
...
> ##### `targets` (type: `stirng | [string]`) (optional)
> 
...
> ##### `resolvePackageReferences` (type: `string`) (optional)
> 
